...
// Date: 2023/8
// Edit: 
// clk,resetc,pclk,vsync,href,D_data,testmode,vga_red,vga_green,vga_blue,vga_hsync,vga_vsync,sioc_to_ov7670,siod_to_ov7670,ov7670_xclk,ov7670_pwdn,ov7670_reset
...
clock_PLL_100_50_25MHz clock_PLL_100_50_25MHz(
  ...
  .clk_out2(clk_50mhz),
  .clk_out3(clk_25mhz),  
  .resetn(resetc), // Status and control signals            
  .locked(locked), 
