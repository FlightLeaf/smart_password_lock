...
HD_PWD='D:/Desktop/verilog/smart_password_lock/smart_password_lock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyValue.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KeyValue.tcl -notrace
