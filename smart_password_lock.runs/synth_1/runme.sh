...
HD_PWD='D:/Desktop/verilog/smart_password_lock/smart_password_lock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyValue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KeyValue.tcl
